...
while True:
    ...
    gray = cv2.GaussianBlur(gray, (21, 21), 0)# ORIGINAL CODE
    ...
    ##(_, cnts, _) = find()##cv2.findContours(thresh_frame.copy(),
    ...
    for (x, y, w, h) in faces:
        ...
        if (x>400):
           ...
           if tilteastwest>20:
               ...
               setpantilt(tilteastwest, tiltnorthsouth)
        ...
        cv2.putText(img, displaytext, (205, 205), cv2.FONT_HERSHEY_COMPLEX_SMALL, .7, (225, 0, 0))
